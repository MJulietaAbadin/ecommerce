                        ...
                        <Form className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <Field type="email" name="email" id="email" className="w-full border border-black rounded p-2 text-black" />
                                    <ErrorMessage name="email" component="div" className="text-red-600 text-sm" />
                                </div>
                                <div>
                                    <label htmlFor="password" className="block text-white mb-1">Password</label>
                                    <Field type="password" name="password" id="password" className="w-full border border-black rounded p-2 text-black" />
                                    <ErrorMessage name="password" component="div" className="text-red-600 text-sm" />
                                </div>
                            </div>
                            <div>
                                <label htmlFor="address" className="block text-white mb-1">Address</label>
                                <Field type="text" name="address" id="address" className="w-full border border-black rounded p-2 text-black" />
                                <ErrorMessage name="address" component="div" className="text-red-600 text-sm" />
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="name" className="block text-white mb-1">Name</label>
                                    <Field type="text" name="name" id="name" className="w-full border border-black rounded p-2 text-black" />
                                    <ErrorMessage name="name" component="div" className="text-red-600 text-sm" />
                                </div>
                                <div>
                                    <label htmlFor="phone" className="block text-white mb-1">Phone</label>
                                    <Field type="text" name="phone" id="phone" className="w-full border border-black rounded p-2 text-black" />
                            ...
                            <p className="text-center text-pageColor"><Link href="/login">LOG IN</Link></p>
                        </Form>
                    )}
                </Formik>
            </div>
