      ...
      <div className="flex justify-end">
        <div className="text-end w-2/3 flex flex-col ">
          ...
          <p className="text-white text-center text-xs font-light">
            At DIGITAL DEPOT, we're dedicated to bringing you the best in tech.
            Explore our curated selection and enjoy exceptional quality and
            service.
          </p>
        </div>
      </div>
