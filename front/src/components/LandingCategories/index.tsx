...
export default function LandingCategories() {
  return (
    <div className="flex gap-10 ms-10 me-10 ">
      <Link
        href="/products/1"
        className="flex-1 flex bg-black bg-opacity-50 rounded-full items-center justify-center transition-transform duration-300 hover:scale-105 hover:bg-opacity-90"
      >
        {iPhoneIcon}
